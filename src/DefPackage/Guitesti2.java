...
public class Guitesti2 {
    ...
    public void startGui (double saldo, double today, double week, ObservableList paaruuat, ObservableList lisukkeet, ObservableList kasvisruuat, ObservableList jalkkarit){
    // ---------------- OIKEA REUNA -------------------
